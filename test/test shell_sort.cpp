...
TEST_CASE("ShellSort") {
	...
	shell_sort(array1, array1_size);
	shell_sort(array2, array2_size);
	shell_sort(array3, array3_size);
	shell_sort(array4, array4_size);
	shell_sort(array5, array5_size);
	shell_sort(array6, array6_size);
